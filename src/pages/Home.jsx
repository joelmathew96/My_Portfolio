...
const skills = {
    Backend: ['Node.js', 'ASP.NET', 'PHP', 'Python'],
    Frontend: ['HTML5', 'CSS3', 'JavaScript', 'React.js', 'Tailwind CSS'],
    Databases: ['MongoDB', 'MySQL', 'SQL Server'],
    Tools: ['Git', 'Github'],
    CMS_Platform: ['WordPress', 'WooCommerce', 'Shopify', 'Drupal', 'Wix'],
    API_Integration: ['RESTAPI'],

    
}

const FULL_NAME = 'JOEL MATHEW'
                ...
                <div className="container">
                    <div className="contact__card reveal card">
                        ...
                        <div className="contact__actions">
                            <a href="mailto:joelmathew960802@gmail.com" className="btn btn-outline">
                                <FaEnvelope /> Send an Email
                            </a>
                            <a href="https://www.linkedin.com/in/joel-mathew-4556a315a/" target="_blank" rel="noreferrer" className="btn btn-outline">
                                <FaLinkedin /> LinkedIn
                            </a>
                        </div>
                    </div>
